  ...
  return (
    <section id="MyWorks" className="myworks  pt-sm-5 pt-1  mt-5  text-white">
      ...
      <div class="container full-width pt-sm-5 pt-1 mt-5">
        ...
        <Slider {...settings}>
          <div className="slide">
                <a href="https://nilohealth.com/" target="_blank" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://hastee.com/" target="_blank" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://www.jusre.be/" target="_blank" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://visitas.haciendaguzman.com/" target="_blank" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://cosmoclinic.it/" target="_blank" className="d-block position-relative h-100 overflow-hidden">
