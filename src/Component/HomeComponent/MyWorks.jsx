    ...
    <section id="MyWorks" className="myworks  pt-sm-5 pt-1  mt-5  text-white">
      ...
      <div class="container full-width pt-sm-5 pt-1 mt-5">
        ...
        <Slider {...settings}>
          ...
          <div className="slide">
                <a href="https://www.reb8fx.com/" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://claritymalaga.com/en/" className="d-block position-relative h-100 overflow-hidden">
          ...
          <div className="slide">
                <a href="https://jmbliss.com/" className="d-block position-relative h-100 overflow-hidden">
